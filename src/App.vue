...
export default {
  ...
  data() {
    return {
      ...
      // den data (immutable)
      trees: [
        {berries: ['salacberry', 'lumberry', 'keeberry', 'marangaberry', 'kebiaberry', 'colburberry'], pokemon: ['819', '420'], img: "https://www.serebii.net/swordshield/berry/axew'seye.jpg", info: {name: "Axew's Eye", link: "https://www.serebii.net/pokearth/galar/axew'seye.shtml"}, position: {x: 645, y: 1480}},
        {berries: ['kelpsyberry', 'qualotberry', 'sitrusberry', 'passhoberry', 'wikiberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/bridgefield1.jpg', info: {name: 'Bridge Field', link: 'https://www.serebii.net/pokearth/galar/bridgefield.shtml'}, position: {x: 0, y: 0}},
        {berries: ['pomegberry', 'tamatoberry', 'sitrusberry', 'occaberry', 'figyberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/bridgefield2.jpg', info: {name: 'Bridge Field', link: 'https://www.serebii.net/pokearth/galar/bridgefield.shtml'}, position: {x: 0, y: 0}},
        {berries: ['hondewberry', 'grepaberry', 'sitrusberry', 'rindoberry', 'aguavberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/bridgefield3.jpg', info: {name: 'Bridge Field', link: 'https://www.serebii.net/pokearth/galar/bridgefield.shtml'}, position: {x: 0, y: 0}},
        {berries: ['ganlonberry', 'liechiberry', 'roseliberry', 'babiriberry', 'chopleberry', 'kasibberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/bridgefield4.jpg', info: {name: 'Bridge Field', link: 'https://www.serebii.net/pokearth/galar/bridgefield.shtml'}, position: {x: 0, y: 0}},
        {berries: ['oranberry', 'chestoberry', 'pechaberry', 'persimberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/dappledgrove1.jpg', info: {name: 'Dappled Grove', link: 'https://www.serebii.net/pokearth/galar/dappledgrove.shtml'}, position: {x: 0, y: 0}},
        {berries: ['oranberry', 'chestoberry', 'rawstberry', 'pomegberry', 'pechaberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/dappledgrove2.jpg', info: {name: 'Dappled Grove', link: 'https://www.serebii.net/pokearth/galar/dappledgrove.shtml'}, position: {x: 0, y: 0}},
        {berries: ['chestoberry', 'rawstberry', 'leppaberry', 'chilanberry', 'grepaberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/dappledgrove3.jpg', info: {name: 'Dappled Grove', link: 'https://www.serebii.net/pokearth/galar/dappledgrove.shtml'}, position: {x: 0, y: 0}},
        {berries: ['pechaberry', 'rawstberry', 'oranberry', 'chilanberry', 'apicotberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/dappledgrove4.jpg', info: {name: 'Dappled Grove', link: 'https://www.serebii.net/pokearth/galar/dappledgrove.shtml'}, position: {x: 0, y: 0}},
        {berries: ['ganlonberry', 'tamatoberry', 'qualotberry', 'apicotberry', 'lumberry', 'leftoversberry'], pokemon: ['819', '420'], img: "https://www.serebii.net/swordshield/berry/giant'scap.jpg", info: {name: "Giant's Cap", link: "https://www.serebii.net/pokearth/galar/giant'scap.shtml"}, position: {x: 0, y: 0}},
        {berries: ['kelpsyberry', 'hondewberry', 'tamatoberry', 'pomegberry', 'qualotberry', 'grepaberry', 'leftoversberry'], pokemon: ['819', '420'], img: "https://www.serebii.net/swordshield/berry/giant'smirror.jpg", info: {name: "Giant's Mirror", link: "https://www.serebii.net/pokearth/galar/giant'smirror.shtml"}, position: {x: 0, y: 0}},
        {berries: ['sitrusberry', 'chestoberry', 'aspearberry', 'leppaberry', 'qualotberry', 'ganlonberry'], pokemon: ['819', '420'], img: "https://www.serebii.net/swordshield/berry/giant'sseat.jpg", info: {name: "Giant's Seat", link: "https://www.serebii.net/pokearth/galar/giant'sseat.shtml"}, position: {x: 0, y: 0}},
        {berries: ['sitrusberry', 'kelpsyberry', 'hondewberry', 'iapapaberry', 'magoberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/hammerlockehills1.jpg', info: {name: 'Hammerlocke Hills', link: 'https://www.serebii.net/pokearth/galar/hammerlockehills.shtml'}, position: {x: 0, y: 0}},
        {berries: ['leppaberry', 'pomegberry', 'grepaberry', 'wacanberry', 'petayaberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/hammerlockehills2.jpg', info: {name: 'Hammerlocke Hills', link: 'https://www.serebii.net/pokearth/galar/hammerlockehills.shtml'}, position: {x: 0, y: 0}},
        {berries: ['apicotberry', 'petayaberry', 'habanberry', 'yacheberry', 'chartiberry', 'shucaberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/lakeofoutrage.jpg', info: {name: 'Lake of Outrage', link: 'https://www.serebii.net/pokearth/galar/lakeofoutrage.shtml'}, position: {x: 0, y: 0}},
        {berries: ['sitrusberry', 'leppaberry', 'tangaberry', 'cobaberry', 'salacberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/motostokeriverbank1.jpg', info: {name: 'Motostoke Riverbank', link: 'https://www.serebii.net/pokearth/galar/motostokeriverbank.shtml'}, position: {x: 0, y: 0}},
        {berries: ['pomegberry', 'grepaberry', 'qualotberry', 'kelpsyberry', 'hondewberry', 'tamatoberry', 'leftoversberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/motostokeriverbank2.jpg', info: {name: 'Motostoke Riverbank', link: 'https://www.serebii.net/pokearth/galar/motostokeriverbank.shtml'}, position: {x: 0, y: 0}},
        {berries: ['rawstberry', 'persimberry', 'hondewberry', 'aspearberry', 'petayaberry'], pokemon: ['819', '819', '420'], img: 'https://www.serebii.net/swordshield/berry/northlakemiloch.jpg', info: {name: 'North Lake Miloch', link: 'https://www.serebii.net/pokearth/galar/northlakemiloch.shtml'}, position: {x: 0, y: 0}},
        {berries: ['oranberry', 'pechaberry', 'cheriberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/rollingfields1.jpg', info: {name: 'Rolling Fields', link: 'https://www.serebii.net/pokearth/galar/rollingfields.shtml'}, position: {x: 0, y: 0}},
        {berries: ['oranberry', 'persimberry', 'cheriberry', 'kelpsyberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/rollingfields2.jpg', info: {name: 'Rolling Fields', link: 'https://www.serebii.net/pokearth/galar/rollingfields.shtml'}, position: {x: 0, y: 0}},
        {berries: ['sitrusberry', 'leppaberry', 'oranberry', 'cheriberry', 'rawstberry', 'liechiberry'], pokemon: ['819', '420'], img: 'https://www.serebii.net/swordshield/berry/watchtowerruins.jpg', info: {name: 'Watchtower Ruins', link: 'https://www.serebii.net/pokearth/galar/watchtowerruins.shtml'}, position: {x: 0, y: 0}},
      ],
      dens: [
