  ...
  <div id="app">
    ...
    <Moveable v-bind='moveable' @drag='handleDrag' ref='moveableTarget'>
      <div id='wild-area-map' ref='wildAreaMap'>
        ...
        <DenLocation v-for="(den, index) in dens" :key="index" :position='den.position' :commonDen='denPokemon[den.commonID]' :rareDen='denPokemon[den.rareID]' :gmax='denPokemon[den.rareID] && (denPokemon[den.commonID].gmax || denPokemon[den.rareID].gmax)' :screenshotImg='den.img'/>
      </div>
    </Moveable>
