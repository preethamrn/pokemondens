...
export default {
  ...
  data() {
    return {
      ...
      // den data (immutable)
      trees: [
        {info: {name: "Axew's Eye", link: "https://www.serebii.net/pokearth/galar/axew'seye.shtml"}, berries: ['salacberry', 'lumberry', 'keeberry', 'marangaberry', 'kebiaberry', 'colburberry'], pokemon: ['820', '420'], img: "https://www.serebii.net/swordshield/berry/axew'seye.jpg", position: {x: 645, y: 1480}},
        {info: {name: 'Bridge Field', link: 'https://www.serebii.net/pokearth/galar/bridgefield.shtml'}, berries: ['kelpsyberry', 'qualotberry', 'sitrusberry', 'passhoberry', 'wikiberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/bridgefield1.jpg', position: {x: 1000, y: 813}},
        {info: {name: 'Bridge Field', link: 'https://www.serebii.net/pokearth/galar/bridgefield.shtml'}, berries: ['pomegberry', 'tamatoberry', 'sitrusberry', 'occaberry', 'figyberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/bridgefield2.jpg', position: {x: 960, y: 813}},
        {info: {name: 'Bridge Field', link: 'https://www.serebii.net/pokearth/galar/bridgefield.shtml'}, berries: ['hondewberry', 'grepaberry', 'sitrusberry', 'rindoberry', 'aguavberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/bridgefield3.jpg', position: {x: 920, y: 813}},
        {info: {name: 'Bridge Field', link: 'https://www.serebii.net/pokearth/galar/bridgefield.shtml'}, berries: ['ganlonberry', 'liechiberry', 'roseliberry', 'babiriberry', 'chopleberry', 'kasibberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/bridgefield4.jpg', position: {x: 1022, y: 950}},
        ...
        {info: {name: "Giant's Cap", link: "https://www.serebii.net/pokearth/galar/giant'scap.shtml"}, berries: ['ganlonberry', 'tamatoberry', 'qualotberry', 'apicotberry', 'lumberry', 'leftovers'], pokemon: ['820', '420'], img: "https://www.serebii.net/swordshield/berry/giant'scap.jpg", position: {x: 688, y: 504}},
        {info: {name: "Giant's Mirror", link: "https://www.serebii.net/pokearth/galar/giant'smirror.shtml"}, berries: ['kelpsyberry', 'hondewberry', 'tamatoberry', 'pomegberry', 'qualotberry', 'grepaberry', 'leftovers'], pokemon: ['820', '420'], img: "https://www.serebii.net/swordshield/berry/giant'smirror.jpg", position: {x: 1306, y: 394}},
        {info: {name: "Giant's Seat", link: "https://www.serebii.net/pokearth/galar/giant'sseat.shtml"}, berries: ['sitrusberry', 'chestoberry', 'aspearberry', 'leppaberry', 'qualotberry', 'ganlonberry'], pokemon: ['820', '420'], img: "https://www.serebii.net/swordshield/berry/giant'sseat.jpg", position: {x: 1175, y: 1678}},
        {info: {name: 'Hammerlocke Hills', link: 'https://www.serebii.net/pokearth/galar/hammerlockehills.shtml'}, berries: ['sitrusberry', 'kelpsyberry', 'hondewberry', 'iapapaberry', 'magoberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/hammerlockehills1.jpg', position: {x: 980, y: 226}},
        {info: {name: 'Hammerlocke Hills', link: 'https://www.serebii.net/pokearth/galar/hammerlockehills.shtml'}, berries: ['leppaberry', 'pomegberry', 'grepaberry', 'wacanberry', 'petayaberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/hammerlockehills2.jpg', position: {x: 792, y: 132}},
        {info: {name: 'Lake of Outrage', link: 'https://www.serebii.net/pokearth/galar/lakeofoutrage.shtml'}, berries: ['apicotberry', 'petayaberry', 'habanberry', 'yacheberry', 'chartiberry', 'shucaberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/lakeofoutrage.jpg', position: {x: 741, y: 143}},
        {info: {name: 'Motostoke Riverbank', link: 'https://www.serebii.net/pokearth/galar/motostokeriverbank.shtml'}, berries: ['sitrusberry', 'leppaberry', 'tangaberry', 'cobaberry', 'salacberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/motostokeriverbank1.jpg', position: {x: 1055, y: 1204}},
        {info: {name: 'Motostoke Riverbank', link: 'https://www.serebii.net/pokearth/galar/motostokeriverbank.shtml'}, berries: ['pomegberry', 'grepaberry', 'qualotberry', 'kelpsyberry', 'hondewberry', 'tamatoberry', 'leftovers'], pokemon: ['820', '420'], img: 'https://www.serebii.net/swordshield/berry/motostokeriverbank2.jpg', position: {x: 823, y: 1136}},
        {info: {name: 'North Lake Miloch', link: 'https://www.serebii.net/pokearth/galar/northlakemiloch.shtml'}, berries: ['rawstberry', 'persimberry', 'hondewberry', 'aspearberry', 'petayaberry'], pokemon: ['820', '819', '420'], img: 'https://www.serebii.net/swordshield/berry/northlakemiloch.jpg', position: {x: 1123, y: 1272}},
